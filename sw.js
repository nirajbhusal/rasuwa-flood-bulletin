/* रसुवा बाढी · सूचना · SW_VER 2026-09-25-mobile-header-art */
...
const STATIC_CACHE = 'rasuwa-static-2026-09-25-mobile-header-art';
const SW_VER = '2026-09-25-mobile-header-art';
const PAGE_VER = '2026-09-25-mobile-header-art';
  ...
  e.waitUntil((async () => {
    try {
      ...
      await c.addAll([
        ...
        new URL('bulletin.min.css?v=' + PAGE_VER, SCOPE).href,
