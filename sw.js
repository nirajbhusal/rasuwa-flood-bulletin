/* रसुवा बाढी · सूचना · SW_VER 2026-09-24-map-colors */
...
const STATIC_CACHE = 'rasuwa-static-2026-09-24-map-colors';
const SW_VER = '2026-09-24-map-colors';
const PAGE_VER = '2026-09-24-map-colors';
